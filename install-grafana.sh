...
# installing loki
wget https://github.com/grafana/loki/releases/download/v2.4.0/loki-linux-arm.zip -O /home/$user/grafana/loki-linux-arm.zip
...
wget https://raw.githubusercontent.com/grafana/loki/v2.4.0/cmd/loki/loki-local-config.yaml -O /home/$user/grafana/loki-local-config.yaml
